...
import './App.css';
import abhiImage from "./Teja.jpg"; 
...
function App() {
  ...
  return (
    <div className="App">
      <header>
        <div className="user">
          <img src={abhiImage} alt="Srinivasa Teja" />
      ...
      <section className="home" id="home">
        <h3>HELLO!!</h3>
        <h1>This is <span>Srinivasa Teja</span></h1>
      </section>
      ...
      <section className="about" id="about">
        ...
        <div className="row">
          <div className="info">
            <h3> <span> Name : </span>Srinivasa Teja </h3>
            <h3> <span> Qualification : </span> B.Tech 3rd year </h3>
            <h3> <span> Address</span> Naidupet</h3>
      ...
      <section className="education" id="education">
        ...
        <div className="box-container">
          <div className="box">
            ...
            <span>2018-2019</span>
            <h3>SSC</h3>
            <p style={{ fontSize: '20px' }}>Vema High School,Naidupet</p>
          </div>
          <div className="box">
            <i className="fas fa-graduation-cap"></i>
            <span>2019-2021</span>
            <h3>Intermediate</h3>
            <h3>MPC</h3>
            <p style={{ fontSize: '20px' }}>TMR junior college</p>
          </div>
          <div className="box">
            <i className="fas fa-graduation-cap"></i>
            <span>2021-2025</span>
      ...
      <section className="contact" id="contact">
        ...
        <div className="row">
          <div className="content">
            ...
            <div className="info">
              <h3> <i className="fas fa-envelope"></i>haritejahariteja441@gmail.com</h3>
              <h3> <i className="fas fa-phone"></i> 9398626671  </h3>
              <h3> <i className="fas fa-map-marker-alt"></i> Naidupet </h3>
            </div>
          </div>
        </div>
      </section>
